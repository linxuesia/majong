...
Page({
  ...
  initLevel1() {
    const scenarios = [
      {
        seaTiles: ['一万', '二万', '三万', '四条', '四条', '四条', '五万', '六万', '七万', '八万', '九万', '九万', '九万', '海底'],
        description: '牌墙最后一张牌，你（庄家）摸到了海底牌，正好凑成14张牌胡牌！',
        action: '海底捞月',
        choices: ['海底捞月', '海底炮', '普通胡', '碰牌']
      },
      {
        seaTiles: ['一条', '二条', '三条', '四条', '五条', '六条', '七条', '八条', '八条', '八条', '九条', '九条', '九条', '海底'],
        description: '牌墙最后一张牌，你（闲家）摸到了海底牌，打出后被下家胡了！',
        action: '海底炮',
        choices: ['海底捞月', '海底炮', '普通胡', '吃牌']
      },
      {
        seaTiles: ['一筒', '二筒', '三筒', '四筒', '五筒', '六筒', '六筒', '六筒', '七筒', '八筒', '九筒', '九筒', '九筒', '海底'],
