...
const getTileInfo = (tileText) => {
  ...
  if (LOAD_TYPE === 'sprite') {
    ...
    const x = tileInfo.col * SPRITE_CONFIG.tileWidth + SPRITE_CONFIG.offsetX[tileInfo.row];
    const y = (tileInfo.row * SPRITE_CONFIG.tileHeight) + (tileInfo.row * SPRITE_CONFIG.rowGap) + SPRITE_CONFIG.offsetY[tileInfo.row];
